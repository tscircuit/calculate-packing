...
test("pad width/height should be correct when components are rotated", () => {
  ...
  console.log(
    `  Body size: ${c1Body.size.x.toFixed(3)} x ${c1Body.size.y.toFixed(3)}`,
  )
  ...
  console.log(
    `  Body size: ${c2Body.size.x.toFixed(3)} x ${c2Body.size.y.toFixed(3)}`,
  )
  ...
  console.log(`\nTest verdict:`)
  console.log(
    `  C1 dimensions correct: ${c1Body.size.x.toFixed(3)} x ${c1Body.size.y.toFixed(3)} ✓`,
  )
  console.log(
    `  C2 dimensions ${c2Body.size.x.toFixed(3) === "1.058" && c2Body.size.y.toFixed(3) === "0.529" ? "correct" : "INCORRECT"}: ${c2Body.size.x.toFixed(3)} x ${c2Body.size.y.toFixed(3)} ${c2Body.size.x.toFixed(3) === "1.058" && c2Body.size.y.toFixed(3) === "0.529" ? "✓" : "✗"}`,
  )
})
