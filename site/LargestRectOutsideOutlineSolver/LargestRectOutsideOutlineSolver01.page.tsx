  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <div style={{ marginBottom: "20px" }}>
        <h3>Input Data:</h3>
        <div>Origin: ({origin.x.toFixed(3)}, {origin.y.toFixed(3)})</div>
        <div>Outline points: {fullOutline.length}</div>
        <div>Global bounds: [{globalBounds.minX.toFixed(3)}, {globalBounds.minY.toFixed(3)}] to [{globalBounds.maxX.toFixed(3)}, {globalBounds.maxY.toFixed(3)}]</div>
      </div>
      ...
      <div style={{ marginBottom: "20px" }}>
        ...
        {result ? (
          <div>
            <div>Rectangle found: x={result.x.toFixed(3)}, y={result.y.toFixed(3)}, w={result.w.toFixed(3)}, h={result.h.toFixed(3)}</div>
      ...
      <div className="border-2 border-gray-800 mx-auto" style={{ maxWidth: "600px" }}>
