...
import type { Point, Rect, GlobalBounds } from "./LargestRectOutsideOutlineFromPointSolver"
...
test("LargestRectOutsideOutlineFromPointSolver - basic rectangle outside outline", () => {
  ...
  const solver = new LargestRectOutsideOutlineFromPointSolver(outline, origin, globalBounds)
